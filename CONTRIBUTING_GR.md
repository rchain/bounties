...
- Για να δημιουργήσετε ή να συμμετάσχετε σε ένα ζήτημα, θα πρέπει να:
  ...
  1. [ ] δημηουργήσετε / έχετε έναν [λογαριασμό GitHub](https://github.com/rchain/Members)
...
- Δεν είναι υποχρεωτικό, αλλά πραγματικά βοηθάει το να γίνετε μέλος στο RChain και να εγκριθείτε στο Discord. Αυτό απαιτεί συνδρομή ύψους $20 και KYC (Γνωριζοντας τον Πελάτη Σου). Δείτε το [Becoming a Member](#becoming-a-member) παρακάτω.
...
- Οι προϋπολογισμοί κατανέμονται σε αντικείμενα εργασίας σε τουλάχιστον τρία μέλη. Ο μέσος όρος τριών προτάσεων ορίζει τον προϋπολογισμό.
- Ops (@ lapin7, HJ) εξηγεί στο βίντεο [RChain, Decentralized budgeting and spending](https://www.youtube.com/watch?v=m6xiTWbEdpA)
- Τα μέλη προτείνουν έναν προϋπολογισμό για την επίλυση του προβλήματος.
...
- Βρείτε ένα θέμα στο οποίο θέλετε να διαθέσετε έναν προϋπολογισμό, όπως το #115 "Community Co-Operators"
- Πληκτρολογήστε το όνομα Github σας στην κίτρινη στήλη, για παράδειγμα το AR66 δείχνει τον lapin7
...
- Ο διαχειριστής λειτουργίας ([ops@rchain.coop](ops@rchain.coop)) μπορεί επίσης να προσθέσει σχόλια με αναθέσεις ηλεκτρονικού ταχυδρομείου στα κελιά του θέματος σε αυτό το λογιστικό φύλλο, προκειμένου να τονώσει τον καθορισμό προϋπολογισμών.
...
- Ο συνεργάτης λαμβάνει ένα μήνυμα ηλεκτρονικού ταχυδρομείου με ένα προγεμισμένο τιμολόγιο και επίσης τα απαραίτητα δεδομένα εάν ο συνεργάτης θέλει να φτιάξει το δικό του τιμολόγιο. Ο συνεργάτης αποθηκεύει μια PDF έκδοση του προγεμισμένο τιμολογίου ή του δικού του τιμολογίου στα προσωπικά του [Gdrive of Rchain](https://drive.google.com/drive/folders/0B5I9qM5f_1cfeUZoV01EYjdmOEE) τιμολόγια.
...
2. Την φωτογραφία της αστυνομικής ταυτότητας η του διαβατηρίου
3. Επειβεβαιώσει την πληρωμή της συνδρομής μέλους
4. Επειβεβαιώσει το πρόσωπο σε ζωντανή σύνδεση βίντεο
