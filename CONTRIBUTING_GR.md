...
- Ο συνεργάτης λαμβάνει ένα μήνυμα ηλεκτρονικού ταχυδρομείου με ένα προγεμισμένο τιμολόγιο και επίσης τα απαραίτητα δεδομένα εάν ο συνεργάτης θέλει να φτιάξει το δικό του τιμολόγιο. Ο συνεργάτης αποθηκεύει μια PDF έκδοση του προγεμισμένου τιμολογίου ή του δικού του τιμολογίου στα προσωπικά του [Gdrive of Rchain](https://drive.google.com/drive/folders/0B5I9qM5f_1cfeUZoV01EYjdmOEE) τιμολόγια.
...
4. Επιβεβαίωση του πρόσωπου σε ζωντανή σύνδεση βίντεο
